...
{
    /// <summary>
    /// This is tempporary until roslyn adds support to specfy custom grouping
    /// for given Code Fix Actions
    /// </summary>
    internal static class RoslynPredefinedCodeFixProviderNames
    {
